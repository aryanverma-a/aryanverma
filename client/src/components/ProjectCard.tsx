      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {technologies.map((tech, i) => (
            <span key={i} className="text-xxs uppercase tracking-wider bg-background px-2 py-1 font-mono">
              {tech}
            </span>
          ))}
        </div>
        <a href={projectUrl} className="text-accent text-sm font-medium flex items-center">
